# The name of this view in Looker is "Operational Aggregate Metrics Bkp G3"
view: operational_aggregate_metrics_bkp_g3 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `dca.operational_aggregate_metrics_bkp_g3` ;;
