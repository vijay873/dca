# The name of this view in Looker is "Operational Aggregate Metrics 20240130 Bkp"
view: operational_aggregate_metrics_20240130_bkp {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `dca.operational_aggregate_metrics_20240130_bkp` ;;
