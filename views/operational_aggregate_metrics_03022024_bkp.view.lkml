# The name of this view in Looker is "Operational Aggregate Metrics 03022024 Bkp"
view: operational_aggregate_metrics_03022024_bkp {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `dca.operational_aggregate_metrics_03022024_bkp` ;;
